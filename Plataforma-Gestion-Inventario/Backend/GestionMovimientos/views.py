...
from .serializers import MovimientoStockSerializer, ActualizarStockSerializer, Tran
...
class TransferenciaListCreateAPIView(generics.ListCreateAPIVIew):
    queryset = Transferencia
    serializer_class = TransferenciaSerializer

class TransferenciaDetailAPIView(generics.RetrieveAPIView):
